...
const TaxForm = ({handleNextStep}) => {
    ...
    return (
        <div className="max-w-4xl mx-auto p-8  rounded-lg shadow-lg">
            <h2 className="text-2xl font-semibold mb-4 ">Information Required for Tax Registration</h2>
            <form className="space-y-6" onSubmit={(e) => { e.preventDefault();  handleNextStep()}}>
                ...
                <div>
                    <h3 className="font-medium text-gray-700">What is the main place of business address for the company?</h3>
                ...
                {/* Postal Address */}
                <div>
                    <h3 className="font-medium text-gray-700">For tax correspondence, what is the postal address for the company?</h3>
                    <div className="mt-4 space-y-3">
                        <input
                            type="text"
                            placeholder="Address"
                            value={formData.postalAddress.address}
                    ...
                    <div className="mt-2 space-y-2">
                        <label className="inline-flex items-center">
                            <input
                                ...
                                name="fringeBenefits"
                                value="no"
                                checked={formData.fringeBenefits === "no"}
                                onChange={handleInputChange}
                                className="form-radio text-blue-600"
                            />
                            <span className="ml-2">No</span>
                        ...
                        <label className="inline-flex items-center">
                            <input
                                ...
                                name="fringeBenefits"
                                value="yes"
                                checked={formData.fringeBenefits === "yes"}
                                onChange={handleInputChange}
                                className="form-radio text-blue-600"
                            />
                            <span className="ml-2">Yes</span>
